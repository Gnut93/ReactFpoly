    ...
    <div id="chitiet">
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <p className="gia">
            Giá: {roundToThousand(parseInt(sp.gia)).toLocaleString("vi")} VNĐ
          </p>
          <p className="mt-3">
      ...
      <div className="row">
        {relatedProducts.map((relatedSp) => (
          <div className="col-md-4" key={relatedSp.id_sp}>
            ...
            <Link className="name-product" to={`/sp/${sp.id_sp}`}><img src={relatedSp.hinh} width="100%" alt={relatedSp.ten_sp} /></Link>
              <h4>{relatedSp.ten_sp}</h4>
              <p className="gia">
                Giá:{" "}
                {roundToThousand(parseInt(relatedSp.gia)).toLocaleString("vi")}
                VNĐ
              </p>
              <button className="btn btn-primary">Mua hàng</button>
            </div>
